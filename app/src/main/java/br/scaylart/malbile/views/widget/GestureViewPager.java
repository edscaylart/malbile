package br.scaylart.malbile.views.widget;
...
import br.scaylart.malbile.views.fragments.PageFragment;
        ...
        public boolean onDoubleTap(MotionEvent motionEvent) {
            if (mGestureImageView != null) {
                if (mGestureImageView.isInitialized()) {
                    if (mGestureImageView.getScale() > GestureImageView.MIN_SCALE) {
                        mGestureImageView.zoomToPoint(GestureImageView.MIN_SCALE, getWidth() / 2, getHeight() / 2);
                    } else if (mGestureImageView.getScale() < GestureImageView.MAX_SCALE) {
                        mGestureImageView.zoomToPoint(GestureImageView.MAX_SCALE, motionEvent.getX(), motionEvent.getY());
                    }
                }
            }
