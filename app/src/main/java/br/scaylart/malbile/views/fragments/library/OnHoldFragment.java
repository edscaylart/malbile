...
import br.scaylart.malbile.presenters.LibraryOnHoldPresenterImpl;
import br.scaylart.malbile.utils.wrappers.LibraryWrapper;
import br.scaylart.malbile.views.fragments.BaseListFragment;

public class OnHoldFragment extends BaseListFragment implements StatusUpdateListener {
    ...
    public static OnHoldFragment newInstance(LibraryWrapper mRequest) {
        OnHoldFragment newInstance = new OnHoldFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (arguments != null) {
            mLibraryPresenter = new LibraryOnHoldPresenterImpl(this, this);
        }
    }
