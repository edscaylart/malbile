...
import br.scaylart.malbile.presenters.MangaPresenterImpl;
...
public class MangaActivity extends BaseActivity implements MangaView, MangaMapper {
    ...
    public static Intent constructMangaActivityIntent(Context context, ReaderWrapper mangaRequest) {
        Intent argumentIntent = new Intent(context, MangaActivity.class);
        argumentIntent.putExtra(PRESENTER_ARGUMENT_KEY, MangaPresenterImpl.TAG);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMangaPresenter = new MangaPresenterImpl(this, this);
    ...
    public void initializeToolbar() {
        if (mToolbar != null) {
            mToolbar.setTitle(R.string.navigation_manga_title);
