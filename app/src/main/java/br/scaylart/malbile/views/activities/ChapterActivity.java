...
import br.scaylart.malbile.presenters.ChapterPresenter;
import br.scaylart.malbile.presenters.ChapterPresenterImpl;
...
import br.scaylart.malbile.views.widget.GestureViewPager;
...
public class ChapterActivity extends BaseActivity implements ChapterView, ChapterMapper {
    ...
    public static Intent constructChapterActivityIntent(Context context, ReaderWrapper chapterRequest, int position) {
        Intent argumentIntent = new Intent(context, ChapterActivity.class);
        argumentIntent.putExtra(PRESENTER_ARGUMENT_KEY, ChapterPresenterImpl.TAG);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChapterPresenter = new ChapterPresenterImpl(this, this);
    ...
    public void setSubtitleProgressText(int imageUrlsCount) {
        if (mToolbar != null) {
            ...
            mToolbar.setSubtitle(getString(R.string.chapter_subtitle_progress) + " " + imageUrlsCount);
        }
    }
    ...
    public void setSubtitlePositionText(int position) {
        if (mToolbar != null) {
            if (mViewPager.getAdapter() != null) {
                ...
                mToolbar.setSubtitle(getString(R.string.chapter_subtitle_page) + " " + position + "/" + mViewPager.getAdapter().getCount());
            }
        }
    }
