...
import br.scaylart.malbile.presenters.LibraryPlannedPresenterImpl;
import br.scaylart.malbile.utils.wrappers.LibraryWrapper;
import br.scaylart.malbile.views.fragments.BaseListFragment;

public class PlannedFragment extends BaseListFragment implements StatusUpdateListener {
    public static final String TAG = PlannedFragment.class.getSimpleName();
    ...
    public static PlannedFragment newInstance(LibraryWrapper mRequest) {
        PlannedFragment newInstance = new PlannedFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (arguments != null) {
            mLibraryPresenter = new LibraryPlannedPresenterImpl(this, this);
        }
    }
