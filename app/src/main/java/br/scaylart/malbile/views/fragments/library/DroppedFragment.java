...
import br.scaylart.malbile.presenters.LibraryDroppedPresenterImpl;
import br.scaylart.malbile.utils.wrappers.LibraryWrapper;
import br.scaylart.malbile.views.fragments.BaseListFragment;

public class DroppedFragment extends BaseListFragment implements StatusUpdateListener {
    public static final String TAG = DroppedFragment.class.getSimpleName();
    ...
    public static DroppedFragment newInstance(LibraryWrapper mRequest) {
        DroppedFragment newInstance = new DroppedFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (arguments != null) {
            mLibraryPresenter = new LibraryDroppedPresenterImpl(this, this);
        }
    }
