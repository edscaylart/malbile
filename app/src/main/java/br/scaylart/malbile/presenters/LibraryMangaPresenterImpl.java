...
public class LibraryMangaPresenterImpl extends BaseLibraryPresenterImpl {
    public static final String TAG = LibraryMangaPresenterImpl.class.getSimpleName();

    private static final String REQUEST_PARCELABLE_KEY = TAG + ":" + "RequestParcelableKey";
    private static final String POSITION_PARCELABLE_KEY = TAG + ":" + "PositionParcelableKey";

    public LibraryMangaPresenterImpl(LibraryView libraryView, LibraryMapper libraryMapper) {
    ...
    public void handleInitialArguments(Bundle arguments) {
        if (arguments != null) {
            if (arguments.containsKey(MangaMalFragment.REQUEST_ARGUMENT_KEY)) {
                mLibraryWrapper = arguments.getParcelable(MangaMalFragment.REQUEST_ARGUMENT_KEY);
                arguments.remove(MangaMalFragment.REQUEST_ARGUMENT_KEY);
            }
        }
    }
